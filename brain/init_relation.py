...
rel = [
    ...
    ("Siri", "est", "une simple connaissance, mais nous avons suivis des cheins bien différents."),
    ("siri", "est", "une simple connaissance, mais nous avons suivis des cheins bien différentes."),
