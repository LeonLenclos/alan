...
class KesakoAdapter(AlanLogicAdapter):
    """This adapter answer to questions about the nature of things, like 'Qu'est
     ce que c'est ... '.
    If he don't know the thing that is asked for, Alan asks about this thing."""
    ...
    def process(self, statement):
        ...
        # If concept_A is related by the relation "est" to another concept, put
        # this concept into concept_B
        if self.chatbot.storage.get_related_concept(concept_A, "est"):
        ...
        elif  self.chatbot.storage.get_related_concept(concept_A, "est",
        reverse=True):
